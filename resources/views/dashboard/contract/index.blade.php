    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    <h3 class="card-label">لائحة العقود
                        @if(count($contracts) > 0)
                                <span class="d-block text-muted pt-2 font-size-sm"> عدد العقود : {{count($contracts)}}  </span>
                        @else
                ...
                <div class="card-toolbar">
                            ...
                            <button type="button" class="btn btn-light-primary font-weight-bolder dropdown-toggle"
                             ...
                             <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    @can('list-user')
                                        <li class="navi-item">
                                            <a href="dash/contracts/export" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="la la-file-excel"></i>
                                                </span>
                                                <span class="navi-text">استخراج لائحة العقود</span>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>
                    ...
                    <!--begin::Button-->
                    @can('create-user')
                        <a href="dash/contracts/create" class="btn btn-primary font-weight-bolder">
                            <span class="svg-icon svg-icon-md">
            ...
            <div class="card-body">
                <form id="deleteMultiForm" action="dash/contracts/delete-multi" method="post">
                @csrf
                <!--begin: Datatable-->
                ...
                <form id="deleteForm" action="dash/contracts/{id}" method="post">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalFormTitle">هل أنت متأكد من حذف العقد؟</h5>
                        </div>
        ...
        <div class="modal fade" id="deleteMultiModal" tabindex="-1" aria-labelledby="exampleModalFormTitle"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalFormTitle">هل أنت متأكد من حذف العقود؟</h5>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">
                            إغلاق
