                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-4">
                            ...
                            <input type="text" name="children_number" value="{{old('children_number')}}"
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <input type="text" id="postal_account" name="postal_account_number" value="{{old('surname')}}" autocomplete="given-name"
                                   class="form-control form-control-solid" placeholder="أدخل رقم الحساب البريدي الجاري"
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <input type="text" id="social_security" name="social_security_number" value="{{old('surname')}}" autocomplete="given-name"
